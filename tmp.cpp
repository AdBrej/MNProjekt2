...
//    int sizeRow = A.sizeRow;//Matrix iI and tmp have the same size as A
...
//            if(row2 != row){
//                b = tmp.Matrix[row2][row];
//                for (int col = row2; col < sizeCol && row2 > row; ++col) {
...
//    Matrix multipleAandI = multiplyMatrix(A, I);
//    Matrix Add = addMatrixNxN(multipleAandI, B, mConst::ODEJMOWANIE);
//    result.norm = norm(Add);
...
//    }
//    AA.Matrix = y4;
//    Result R4 = GaussS(AA, BB, mConst::eps);
//    std::cout<<"----------------------------------------------------" <<std::endl;
